...
export const SleepModule: React.FC = () => {
    const { isConnected, loading, hasChecked, sleepData, weeklySleepData, connect, disconnect, fetchSleepData, fetchWorkoutData, fetchVitalData, fetchIntradayHR, fetchDailyActivity, checkConnection } = useWithingsStore();
                            ...
                            <div className="flex gap-2">
                                <button onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        await state.fetchDailyActivity();
                                ...
                                <button onClick={() => { fetchSleepData(); fetchWorkoutData(); fetchVitalData(); fetchIntradayHR(); fetchDailyActivity(); }} disabled={loading} className="p-2 text-zinc-400 hover:text-white bg-zinc-900 border border-zinc-800 rounded-lg transition-colors disabled:opacity-50" title="Refresh Data">
